...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 21 23:17:25 2021
...
print("BCS Social Post Formatter")
...
upbutton = '<button id="voteupbutton1" onclick="voted()" class="btn btn-outline-dark btn-sm" type="button" title="Likes | 0 (Updated June 16th)">vote<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
